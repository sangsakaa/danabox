<x-app-layout>
    ...
    <div class=" bg-white p-2">
        <form action="/suratkeluar/{{$suratkeluar->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class=" grid sm:grid-cols-2 grid-cols-1  gap-2 capitalize">
                <div class=" grid grid-cols-2 gap-2">
                    ...
                    <div> <input type="date" name="tanggal_keluar" class=" w-full  border px-1 py-1 " title="Tanggal Surat Keluar" required value="{{$suratkeluar->tanggal_keluar}}"></div>
                    <label for="">Nomor Surat</label>
                    <div> <input type="text" name="nomor_surat" class=" w-full capitalize border px-1 py-1" placeholder="nomor surat" value="{{$suratkeluar->nomor_surat}}"></div>
        ...
        <div class=" mt-2 w-full">
            <iframe width="100%" height="1000px" src="{{ asset('storage/app/public/public' . $suratkeluar->file)}}" frameborder="0"></iframe>
        </div>
    </div>
