        ...
        <form action="/suratmasuk" method="post" enctype="multipart/form-data">
            ...
            <div class=" grid sm:grid-cols-2 grid-cols-1  gap-1 capitalize">
                ...
                <div class="  grid grid-cols-1 gap-1">
                    ...
                    <input type="date" name="tanggal_surat" class="  border text-sm px-1 py-1 " title="Tanggal Surat" required>
                    <label for="">Nomor Surat</label>
                    <input type="text" name="nomor_surat" class=" capitalize border text-sm px-1 py-1" placeholder="nomor surat">
    ...
    <div class=" text-sm sm:text-xs mt-1 p-2  bg-white  shadow-md dark:bg-dark-eval-1">
        ...
        <div class=" overflow-auto grid sm:grid-cols-1 grid-cols-1 ">
            <table class=" w-full mt-1 ">
                <thead class=" bg-white shadow-md dark:bg-dark  px-1 py-1  mb-1 text-green-800 ">
